            ...
            GUI.BeginGroup(base.building_background_Rect, GUIContent.none, building_Skin.box);
            {
                ...
                GUI.BeginGroup(base.descriptionGroup_Rect, CurrentDescription, building_Skin.textArea);
                {
                    ...
                    if (base.Level < RequireResource.Length)
                    {
                        ...
                        {
                            GUI.Box(GameResource.First_Rect, new GUIContent(RequireResource[Level].Food.ToString(), stageManager.gui_Manager.food_icon), standard_Skin.box);
                            GUI.Box(GameResource.Second_Rect, new GUIContent(RequireResource[Level].Wood.ToString(), stageManager.gui_Manager.wood_icon), standard_Skin.box);
                            GUI.Box(GameResource.Third_Rect, new GUIContent(RequireResource[Level].Stone.ToString(), stageManager.gui_Manager.stone_icon), standard_Skin.box);
                            GUI.Box(GameResource.Fourth_Rect, new GUIContent(RequireResource[Level].Gold.ToString(), stageManager.gui_Manager.gold_icon), standard_Skin.box);
                            GUI.Box(GameResource.Fifth_Rect, new GUIContent(RequireResource[Level].Employee.ToString(), stageManager.gui_Manager.employee_icon), standard_Skin.box);
                        }
                        GUI.EndGroup();
                    }
                    else

...
public class BuildingBeh : MonoBehaviour {
...
//        destructionButton_Rect = new Rect(windowRect.width - 110, 40, 100, 32);
    ...
    public virtual void InitializeBuildingBeh(BuildingStatus p_buildingState, int p_indexPosition, int p_level) {
    ...
    protected virtual void CreateProcessBar(BuildingStatus buildingStatus)
    {
        ...
        {
            processbar_Obj_parent = Instantiate(Resources.Load(GUI_Manager.PathOfGUISprite + "Processbar_Group", typeof(GameObject)),
            ...
            if (processBar_Scolling == null)
            {
                ...
                {
                    GameObject scrolling = Instantiate(Resources.Load(GUI_Manager.PathOfGUISprite + "processbar_scroll", typeof(GameObject))) as GameObject;
                ...
                {
                    GameObject scrolling = Instantiate(Resources.Load(GUI_Manager.PathOfGUISprite + "Destruction_processbar", typeof(GameObject))) as GameObject;
                    scrolling.transform.parent = processbar_Obj_parent.transform;
                    processBar_Scolling = scrolling.GetComponent<OTSprite>();
					processBar_Scolling.spriteContainer = OT.ContainerByName("GUI_Atlas");
    ...
    {
//        if (GUI_Manager.IsShowInteruptGUI == false && !GUI_Manager.IsShowSidebarGUI)
